...
- `docs/manuals/DASHBOARD-MANUAL.md` — pages, routes, data refresh, card behavior, component contracts
- `docs/manuals/DESIGN-MANUAL.md` — card anatomy, grid system, tokens, visual patterns, thumbnails
- `docs/manuals/OPERATIONS-MANUAL.md` — config files, admin UI, deployment, operator workflows
- `docs/manuals/API-MANUAL.md` — published endpoints (the contract card authors reference)
...
- Owner: Coordinator (Opus)
- Files: `docs/ARCHITECTURE.md`, `docs/manuals/DASHBOARD-MANUAL.md`, `docs/manuals/DESIGN-MANUAL.md`, `docs/manuals/OPERATIONS-MANUAL.md`

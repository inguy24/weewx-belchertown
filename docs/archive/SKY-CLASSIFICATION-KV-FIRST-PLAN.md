...
**Status:** COMPLETE — Kv-first decision tree implemented in sky_condition.py, ADR-073 accepted and consolidated into API-MANUAL.md. Archived 2026-06-27.
**Created:** 2026-06-23
...
- Owner: `clearskies-docs-author` (Sonnet)
- File: `docs/manuals/API-MANUAL.md` lines 521–614
...
- Owner: `clearskies-docs-author` (Sonnet)
- File: `docs/manuals/DESIGN-MANUAL.md` (~line 416–424)

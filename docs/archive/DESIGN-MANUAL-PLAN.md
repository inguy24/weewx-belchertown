...
**Status:** COMPLETE — DESIGN-MANUAL.md delivered, 10 UI ADRs archived, CLAUDE.md routing updated. Archived 2026-06-27.
**Created:** 2026-06-16
**Components:** `docs/manuals/DESIGN-MANUAL.md` (new), all UI-related ADRs (reference, not modified), `CLAUDE.md` (routing update)
...
**Deliverable:** `docs/manuals/DESIGN-MANUAL.md` — single file, ~1500-2000 lines, machine-parseable structure.
...
- Do: Write sections 1 through 6 of `docs/manuals/DESIGN-MANUAL.md` using the content specifications above (§3, Sections 1-6). The content is fully specified — the agent formats it into the final document structure. Verify every token value, every table row, and the ASCII anatomy diagram are present.
...
- Do: Add row: "UI design, visual patterns, tokens, component styling → `docs/manuals/DESIGN-MANUAL.md`". Update `rules/coding.md` §9 to reference the manual as the single authority for design rules. Remove ADR references from §9 — the manual replaces them.

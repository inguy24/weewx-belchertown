...
**Status:** **Phase 2 task 1 complete (2026-05-06).** Phase 1 closed 2026-05-05 with 40 ADRs Accepted, OpenAPI contract, canonical-data-model spec, security baseline, and 5 public GitHub repos with Phase 1 CI scaffolding. Phase 2 task 1 (FastAPI scaffold) closed 2026-05-06 with 73 of 73 pytest cases green on `weather-dev` and CI green on github.com/inguy24/weewx-clearskies-api. Phase 2 task 2 (read-only DB user enforcement at startup per [ADR-012](../decisions/ADR-012-database-access-pattern.md)) ready to begin.

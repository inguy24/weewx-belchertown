...
5. **Chart tick fontSize at 11px instead of 14px:** `current-conditions-card.tsx`, `lightning-card.tsx`, `ConfigDrivenChart.tsx`, `MonthlyAveragesCard.tsx`, `WeatherRangeChart.tsx`. Systemic — all chart components use 10-11px instead of the 14px standard.
...
- Standardize chart tick fontSize to 14px
